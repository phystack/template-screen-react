...
**Getting started with a new app:** Run `/setup` to configure this template for your specific app. It will generate a project brief with Jobs to Be Done, decompose self-contained feature specs, create architecture docs, and customize the AI agents for your project.
...
| Skill | Purpose |
|-------|---------|
| `/setup` | Interactive onboarding: generates project brief with JTBD, self-contained features, architecture docs, customizes agents |
...
```
docs/
├── prd/brief.md                  # Project Brief with JTBD (bootstrap document, decomposed into features after /setup)
├── features/NNN-feature-name.md  # Self-contained feature specs (living specifications after /setup)
├── architecture/
